...
return (
    <div className='px-4 py-16'>
        <div>
        <label className='w-full cursor-pointer text-gray-600 flex items-center justify-center border-2 border-dashed border-gray-300 h-48 rounded-md 
        ...
        <textarea className='mt-1 shadow-sm w-full rounded-md border-gray-300
        focus:ring-orange-500
        focus:border-orange-500' 
        rows={4} />
        </div>
